...
public class Usuario {
    ...
    public Usuario(int idUsuario, String nombre, String apellidos, String usuario, String password, int idRol, String estado) {
    ...
    public String toString() {
        return "Usuario{" + "idUsuario=" + idUsuario + ", nombre=" + nombre + ", apellidos=" + apellidos + ", usuario=" + usuario + ", password=" + password + ", idRol=" + idRol + ", estado=" + estado + '}';
    }
